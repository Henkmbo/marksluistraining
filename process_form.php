...
// Configuration
$recipient_emails = ["hvanderkoojj@gmail.com"]; // Add more emails as needed
...
$mail_config = [
    ...
    'smtp_username' => 'hvanderkoojj@gmail.com',  // Your SMTP username/email
    'smtp_password' => 'grjn ctsw aqsm jtqq', // Your SMTP password
    'sender_email' => 'hvanderkoojj@gmail.com',   // Sender email address
...
';
        ...
        $email_success = true;
          try {
            ...
            // Enable debugging
            $mail->SMTPDebug = 2; // Output debug info to the error log
            ...
            if ($mail_config['smtp_auth']) {
                ...
                $mail->SMTPSecure = $mail_config['smtp_security'];
            ...
            // Try both with SMTP and without if SMTP fails
            if (!$mail->send()) {
                // If SMTP fails, try without SMTP (using PHP's mail function directly)
                $mail->isMail();
                if (!$mail->send()) {
            ...
            // For better troubleshooting, include the error in the response in development
